...
const EditStudent = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/teacher/student` + id)
            .then(result => {
                setStudent({
                    ...student,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.put(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/teacher/edit_student/` + id, student)
            .then(result => {
                if (result.data.Status) {
